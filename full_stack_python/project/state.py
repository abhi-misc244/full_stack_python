...
'''class ProjectState(SessionState):
    form_data: dict = {}
    entries: List['ProjectEntryModel'] = []
    did_submit: bool = False

    @rx.var
    def thank_you(self):
        project_name = self.form_data.get("project_name") or ""
        return f"Thank you {project_name}".strip() + "!"
